...
const dataBlog = [
  {
    ...
    konten: [
      { type: "text", content: "Universitas Sumatera Utara (USU) bersama masyarakat Desa Bandar Khalipah menggelar kegiatan sosialisasi dalam rangka pengabdian masyarakat bertajuk “Mewujudkan Kampus Iklim: Bank Sampah dengan pendekatan GEDSI." },
  ...
  },
  {
    ...
    kategori: "edukasi",
    konten: [
        { type: "text", content: "Kegiatan sosialisasi program Bank Sampah di Desa Bandar Khalipah berlangsung meriah dan penuh antusiasme. Acara ini menjadi langkah awal yang penting dalam mendorong kesadaran warga terhadap pengelolaan sampah yang bijak dan bernilai ekonomi." },
        { type: "image", content: kumpulankegiatan10 },
      { type: "text", content: "Sosialisasi ini digagas dan digerakkan oleh Bu Sony, selaku focal point utama dari masyarakat Desa Bandar Khalipah, yang selama ini aktif mengedukasi warga tentang pentingnya memilah dan menabung sampah. Perannya menjadi kunci dalam menghubungkan program ini dengan kebutuhan nyata masyarakat." },
      { type: "text", content: "“Gerakan ini dimulai dari rumah sendiri. Kalau kita bisa memilah dan menabung sampah, kita bukan hanya menjaga lingkungan, tapi juga membantu ekonomi keluarga,” ujar Bu Sony dalam paparannya." },
      { type: "text", content: "Dalam kegiatan ini, Bu Sony bersama tim melakukan demonstrasi langsung mengenai cara penimbangan sampah dan mekanisme penukaran poin yang akan diterapkan dalam sistem bank sampah desa." },
      { type: "text", content: "Acara ini turut dihadiri oleh Pak Arson, tokoh masyarakat yang dikenal peduli terhadap kemajuan desa. Dalam sambutannya, beliau menyampaikan bahwa program bank sampah adalah bentuk kemandirian warga yang patut didukung penuh, karena manfaatnya tidak hanya dirasakan secara individu, tetapi juga secara kolektif untuk desa." },
      { type: "image", content: kumpulankegiatan11 },
      { type: "text", content: "Dukungan juga datang dari Ketua RT setempat, yang mengapresiasi langkah kolaboratif antara warga, tokoh masyarakat, dan institusi pendidikan. Beliau menegaskan bahwa lingkungan bersih adalah tanggung jawab bersama, dan inisiatif seperti ini dapat menjadi teladan bagi wilayah lain." },
      { type: "image", content: kumpulankegiatan8 },
      {type:"text", content:"Kegiatan ini didampingi oleh tim pengabdian dari Universitas Sumatera Utara (USU), yang hadir sebagai bentuk implementasi Tri Dharma Perguruan Tinggi. Dosen pembimbing dari tim tersebut memberikan sambutan pembuka yang menekankan pentingnya membangun sistem yang berkelanjutan dan memberdayakan masyarakat melalui pendekatan edukatif dan partisipatif."},
      { type: "text", content: "Menambah semarak kegiatan, anak-anak desa turut menyambut dan memeriahkan acara dengan menampilkan tarian tradisional, yang menjadi simbol semangat generasi muda dalam mendukung perubahan positif di desanya." },
      { type: "image", content: kumpulankegiatan12 },
      { type: "text", content: "Kegiatan ini menjadi bukti nyata bahwa sinergi antara perguruan tinggi dan masyarakat mampu melahirkan inisiatif lingkungan yang berkelanjutan. Program bank sampah ini diharapkan tidak hanya berdampak pada kebersihan lingkungan, tetapi juga menjadi sumber penguatan ekonomi warga secara mandiri." },
    ],
  },
];
